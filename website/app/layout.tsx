...
export const metadata: Metadata = {
  ...
  description:
    'AStack is a composable AI agent framework built on HLang\'s monadic paradigm. Create powerful AI agents with type-safe components, zero adaptation layers, and direct port connections. Perfect for building autonomous agents, RAG applications, and complex AI workflows in TypeScript.',
  keywords: [
    // Primary keywords
    'AI agent framework',
    'AI agent',
  ...
  openGraph: {
    ...
    description:
      'Build powerful AI agents with type-safe components, zero adaptation layers, and monadic composition. The composable framework for autonomous agents and AI workflows.',
    images: [
      {
        url: '/logo.png',
        width: 240,
  ...
  twitter: {
    ...
    title: 'AStack - AI Agent Framework Built on Monadic Paradigm',
    description:
      'Build powerful AI agents with type-safe components and zero adaptation layers.',
    images: ['/logo.png'],
    creator: '@astack_tech',
  },
  alternates: {
