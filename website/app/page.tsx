...
export default function Home() {
  ...
  const structuredData = {
    ...
    description:
      'AStack is a composable AI agent framework built on HLang\'s monadic FBP paradigm. Create powerful AI agents with type-safe components, Observable streams, and declarative composition.',
